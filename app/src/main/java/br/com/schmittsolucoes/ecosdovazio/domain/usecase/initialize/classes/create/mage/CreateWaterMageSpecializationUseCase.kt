    ...
    fun executeInternal(classId: String): CreateSpecializationResult {
        ...
        val skills = listOf(
            Skill(
                ...
                attributes = Skill.Attributes(requiredIntelligence = 20, requiredMagicResistance = 10)
            ),
            Skill(
                id = identifierProvider.generate(),
                ...
                attributes = Skill.Attributes(requiredIntelligence = 22, requiredDexterity = 14)
            )
        )
